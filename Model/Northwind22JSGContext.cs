...
{
    public partial class Northwind22JSGContext : DbContext
    {
        public Northwind22JSGContext()
        {
        }

        public Northwind22JSGContext(DbContextOptions<Northwind22JSGContext> options)
            : base(options)
        {
        }
